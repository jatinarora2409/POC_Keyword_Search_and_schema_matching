...
/**
 * Bag of words query analyzer
 */
public class BagOfWordsQueryAnalyzer extends Analyzer {
    private final SynonymMap synonymMap;

    private final Logger LOGGER = LoggerFactory.getLogger(BagOfWordsQueryAnalyzer.class);

    public BagOfWordsQueryAnalyzer(SynonymMap synonymMap) {
