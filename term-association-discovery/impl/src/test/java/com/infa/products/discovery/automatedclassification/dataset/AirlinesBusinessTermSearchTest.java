...
public class AirlinesBusinessTermSearchTest {
    ...
    @Test(testName = "testAirlinesDataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Airlines dataset")
    public void testAirlinesDataset()
        ...
        AirlinesDatasetReader reader = new AirlinesDatasetReader();
        reader.read();
