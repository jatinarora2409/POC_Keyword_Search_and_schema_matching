...
public class AnaCreditDatasetReader {

	private static final String AnaCredit_CSV_FILE_PATH = "src/test/resources/sampledata/AnaCredit_Glossary_v2.1.csv";
	...
	public void read() throws IOException {
		try (Reader reader = Files.newBufferedReader(Paths.get(AnaCredit_CSV_FILE_PATH));
