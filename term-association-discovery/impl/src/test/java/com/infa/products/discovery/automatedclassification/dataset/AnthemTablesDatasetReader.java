...
public class AnthemTablesDatasetReader {

    private final String anthemTablesCSVFilePath;
    ...
    public AnthemTablesDatasetReader(String anthemColsCSVFilePath) {
        this.anthemTablesCSVFilePath = anthemColsCSVFilePath;
    }

    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(anthemTablesCSVFilePath));
