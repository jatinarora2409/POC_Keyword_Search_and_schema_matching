...
public class CommunicationsBusinessTermSearchTest {
    ...
    @Test(testName = "testCommunicationsDataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Communications dataset")
    public void testCommunicationsDataset()
        ...
        CommunicationsDatasetReader reader = new CommunicationsDatasetReader();
        reader.read();
...
//        engineBuilder.withSynonyms(synonyms);
        ...
        try (Searcher<BusinessTerm> searcher = engine.getSearcher()) {
            ...
            System.out.println("Communicationstermsearchtest.class");
