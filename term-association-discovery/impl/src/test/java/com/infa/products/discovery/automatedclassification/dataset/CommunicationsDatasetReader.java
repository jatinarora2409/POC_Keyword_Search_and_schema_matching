...
public class CommunicationsDatasetReader {

    private static final String COMMUNICATIONS_CSV_FILE_PATH = "src/test/resources/sampledata/Communications.csv";
    ...
    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(COMMUNICATIONS_CSV_FILE_PATH));
