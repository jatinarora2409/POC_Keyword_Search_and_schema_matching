...
public class FinanceBusinessTermSearchTest {
    ...
    @Test(testName = "testFinanceDataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Finance dataset")
    public void testFinanceDataset()
        ...
        FinanceDatasetReader reader = new FinanceDatasetReader();
        reader.read();
...
//        engineBuilder.withSynonyms(synonyms);
        ...
        try (Searcher<BusinessTerm> searcher = engine.getSearcher()) {
            ...
            System.out.println("Financetermsearchtest.class");
