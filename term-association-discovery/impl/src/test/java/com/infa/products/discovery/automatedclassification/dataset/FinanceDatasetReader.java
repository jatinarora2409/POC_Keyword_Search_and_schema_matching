...
public class FinanceDatasetReader {

    private static final String FINANCE_CSV_FILE_PATH = "src/test/resources/sampledata/Oracle_Finance.csv";
    ...
    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(FINANCE_CSV_FILE_PATH), StandardCharsets.ISO_8859_1);
