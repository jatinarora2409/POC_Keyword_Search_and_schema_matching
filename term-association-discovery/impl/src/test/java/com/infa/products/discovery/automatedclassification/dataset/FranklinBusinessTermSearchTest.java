...
public class FranklinBusinessTermSearchTest {
    ...
    @Test(testName = "testFranklinDataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Franklin dataset")
    public void testFranklinDataset()
        ...
        FranklinDatasetReader reader = new FranklinDatasetReader();
        reader.read();
...
//        engineBuilder.withSynonyms(synonyms);
        ...
        try (Searcher<BusinessTerm> searcher = engine.getSearcher()) {
            ...
            System.out.println("Franklintermsearchtest.class");
