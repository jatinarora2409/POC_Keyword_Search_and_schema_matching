...
public class HealthcareBusinessTermSearchTest {
    ...
    @Test(testName = "testHealthcareDataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Healthcare dataset")
    public void testHealthcareDataset()
        ...
        HealthcareDatasetReader reader = new HealthcareDatasetReader();
        reader.read();
...
//        engineBuilder.withSynonyms(synonyms);
        ...
        try (Searcher<BusinessTerm> searcher = engine.getSearcher()) {
            ...
            System.out.println("Healthcaretermsearchtest.class");
