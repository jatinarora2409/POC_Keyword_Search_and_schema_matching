...
public class HealthcareDatasetReader {

    private static final String HEALTHCARE_CSV_FILE_PATH = "src/test/resources/sampledata/Healthcare.csv";
    ...
    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(HEALTHCARE_CSV_FILE_PATH));
