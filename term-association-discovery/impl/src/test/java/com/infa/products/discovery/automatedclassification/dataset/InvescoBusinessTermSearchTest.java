...
public class InvescoBusinessTermSearchTest {
    ...
    @Test(testName = "testInvescoDataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Invesco dataset")
    public void testInvescoDataset()
        ...
        InvescoDatasetReader reader = new InvescoDatasetReader();
        reader.read();
...
//        engineBuilder.withSynonyms(synonyms);
        ...
        try (Searcher<BusinessTerm> searcher = engine.getSearcher()) {
            ...
            System.out.println("Invescotermsearchtest.class");
