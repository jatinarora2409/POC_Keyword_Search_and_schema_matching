...
public class InvescoDatasetReader {

    private static final String INVESCO_CSV_FILE_PATH = "src/test/resources/sampledata/InvescoGlossaryExport.csv";
    ...
    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(INVESCO_CSV_FILE_PATH));
            ...
            for (CSVRecord csvRecord : csvParser) {
                ...
                String asset = csvRecord.get(3);
                String term = csvRecord.get(10);
