...
public class MichiganBusinessTermSearchTest {
    ...
    @Test(testName = "testMichiganDataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Michigan dataset")
    public void testMichiganDataset()
        ...
        MichiganDatasetReader reader = new MichiganDatasetReader();
        reader.read();
...
//        engineBuilder.withSynonyms(synonyms);
        ...
        try (Searcher<BusinessTerm> searcher = engine.getSearcher()) {
            ...
            System.out.println("Michigantermsearchtest.class");
