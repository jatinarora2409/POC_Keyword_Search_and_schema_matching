...
public class MichiganDatasetReader {

    private static final String MICHIGAN_CSV_FILE_PATH = "src/test/resources/sampledata/MichiganReader.csv";
    ...
    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(MICHIGAN_CSV_FILE_PATH));
