...
public class MichiganERPMBusinessTermSearchTest {
    ...
    @Test(testName = "testMichiganERPMDataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Michigan_ERPM dataset")
    public void testMichiganERPMDataset()
        ...
        MichiganERPMDatasetReader reader = new MichiganERPMDatasetReader();
        reader.read();
...
//        engineBuilder.withSynonyms(synonyms);
        ...
        try (Searcher<BusinessTerm> searcher = engine.getSearcher()) {
            ...
            System.out.println("MichiganERPMtermsearchtest.class");
