...
public class MichiganERPMDatasetReader {

    private static final String MICHIGAN_ERPM_CSV_FILE_PATH = "src/test/resources/sampledata/Michigan ERPM Reader.csv";
    ...
    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(MICHIGAN_ERPM_CSV_FILE_PATH));
