...
public class RealEstateFileReader {

    private static final String REALESTATE_CSV_FILE_PATH = "";
    ...
    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(REALESTATE_CSV_FILE_PATH));
