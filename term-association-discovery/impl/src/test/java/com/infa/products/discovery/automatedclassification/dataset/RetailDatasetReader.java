...
public class RetailDatasetReader {

    private static final String RETAIL_CSV_FILE_PATH = "src/test/resources/sampledata/Retail.csv";
    ...
    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(RETAIL_CSV_FILE_PATH));
