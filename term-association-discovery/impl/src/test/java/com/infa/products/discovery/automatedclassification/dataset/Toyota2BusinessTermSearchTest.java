...
public class Toyota2BusinessTermSearchTest {
    ...
    @Test(testName = "testToyota2Dataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Toyota 2 dataset")
    public void testToyotaDataset()
        ...
        Toyota2DatasetReader reader = new Toyota2DatasetReader();
        reader.read();
...
//        engineBuilder.withSynonyms(synonyms);
        ...
        try (Searcher<BusinessTerm> searcher = engine.getSearcher()) {
            ...
            System.out.println("Toyota2termsearchtest.class");
