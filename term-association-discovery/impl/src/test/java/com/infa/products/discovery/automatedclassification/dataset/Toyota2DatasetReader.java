...
public class Toyota2DatasetReader {

    private static final String AIRLINES_CSV_FILE_PATH = "src/test/resources/sampledata/ToyotaBGExport2.csv";
    ...
    public void read() throws IOException {
        try (Reader reader = Files.newBufferedReader(Paths.get(AIRLINES_CSV_FILE_PATH));
