...
public class ToyotaBusinessTermSearchTest {
    ...
    @Test(testName = "testToyotaDataset", enabled = true, groups = {"TermSearchDatasetTests"}, description = "Test term search with Toyota dataset")
    public void testToyotaDataset()
        ...
        ToyotaDatasetReader reader = new ToyotaDatasetReader();
        reader.read();
...
//        engineBuilder.withSynonyms(synonyms);
        ...
        try (Searcher<BusinessTerm> searcher = engine.getSearcher()) {
            ...
            System.out.println("Toyotatermsearchtest.class");
